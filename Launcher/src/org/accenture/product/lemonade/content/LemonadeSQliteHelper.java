...
//			String sql = "insert into table_wallpapers (wallpapersId,wallpaperstype,use,pagename,pagepath,thumPath,download) values ('001',1,0,'��ɫ','wallpapers/pic1.jpg','wallpapers/thumb1.jpg',1)";
		...
		if (!isTableExits(db, SCENE_TABLE))
		{
			...
			String sql1 = "insert into scene (info,is_use,icon_id,screen_count,pagepath,thumpath) values('Lemonade','1','0','7','scene/personalization_picker_scene_1_thumbnail_l.png','scene/personalization_picker_scene_1_thumbnail_s.png')";
			String sql2 = "insert into scene (info,is_use,icon_id,screen_count,pagepath,thumpath) values('Social','0','0','7','scene/personalization_picker_scene_2_thumbnail_l.png','scene/personalization_picker_scene_2_thumbnail_s.png')";
			String sql3 = "insert into scene (info,is_use,icon_id,screen_count,pagepath,thumpath) values('Business','0','0','7','scene/personalization_picker_scene_3_thumbnail_l.png','scene/personalization_picker_scene_3_thumbnail_s.png')";
			String sql4 = "insert into scene (info,is_use,icon_id,screen_count,pagepath,thumpath) values('Entertainment','0','0','7','scene/personalization_picker_scene_4_thumbnail_l.png','scene/personalization_picker_scene_4_thumbnail_s.png')";
			String sql5 = "insert into scene (info,is_use,icon_id,screen_count,pagepath,thumpath) values('Travel','0','0','7','scene/personalization_picker_scene_5_thumbnail_l.png','scene/personalization_picker_scene_5_thumbnail_s.png')";
			String sql6 = "insert into scene (info,is_use,icon_id,screen_count,pagepath,thumpath) values('Customized','0','0','7','scene/personalization_picker_scene_6_thumbnail_l.png','scene/personalization_picker_scene_6_thumbnail_s.png')";
			String sql7 = "insert into scene (info,is_use,icon_id,screen_count,pagepath,thumpath) values('Customized','0','0','7','scene/personalization_picker_scene_7_thumbnail_l.png','scene/personalization_picker_scene_7_thumbnail_s.png')";
			db.execSQL(sql1);
			db.execSQL(sql2);
			db.execSQL(sql3);
			db.execSQL(sql4);
